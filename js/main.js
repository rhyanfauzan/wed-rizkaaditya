...
(function ($) {
  ...
  $(document).on("ready", function () {
    ...
    $("#count").countdown("2022/01/08", function (event) {
      $(this).html(
        event.strftime(
          "" +
            '<div class="count-block days">%D<span class="count-label">%!H:Hari,Hari;</span></div>' +
            '<div class="count-block hours">%H<span class="count-label">%!H:Jam,Jam;</span></div>' +
            '<div class="count-block minutes">%M<span class="count-label">%!M:menit,menit;</span></div>' +
            '<div class="count-block seconds">%S<span class="count-label">%!S:detik,detik;</span></div>'
        )
      );
    });
